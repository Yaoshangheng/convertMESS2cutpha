...
MAX_VALUE = 0.999
fpha_in = '/home/yaoyuan/Desktop/myprogram/convertMESS2cutpha/ZSYMESSdetect_2016-2018.pha'
fpha_out = '/home/yaoyuan/Desktop/myprogram/convertMESS2cutpha/ZSYMESSdetect_2016-2018_selectCC.pha'
# i/o paths
...
while i < len(lines):
    ...
    if a > 8:
        ...
        if not (eval(cc) >= MIN_VALUE and eval(cc) <= MAX_VALUE):
            i += 1
            while i < len(lines) and len(lines[i].split(',')[0]) <= 8:
                i += 1
            continue
        fout.write('{}{}{}{}{}{}.{},{},{},{},{}'\
